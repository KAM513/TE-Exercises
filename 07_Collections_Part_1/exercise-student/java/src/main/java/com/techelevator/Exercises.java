...
public class Exercises {
    ...
    public List <String> array2List() {
        List <String> fruitString;
        fruitString = new ArrayList <> ();
        return fruitString;
    }
    ...
    public String[] list2Array() {
        ...
        myArrayList.toArray (new Object[0]);
        return null;
    }
    ...
    public List <Double> arrayInt2ListDouble(int[] intArray) {
        List <Double> divideDoubles = new ArrayList <> ();

        for (Integer willDivide : intArray) {
            divideDoubles.add (willDivide / 2.0);
        }
     ...
     */
    public List <Integer> findLargest() {
